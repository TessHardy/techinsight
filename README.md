...
[![A11y](https://img.shields.io/badge/A11y-友好-brightgreen)](#-用户体验)
[![SEO](https://img.shields.io/badge/SEO-优化-blue)](#-seo--分享)
...
- **18 大核心功能**：7 种图表 + 5 大互动玩法 + 6 项体验优化
- **0 第三方依赖**：除 ECharts 外全部原生实现

## 🌐 在线体验

- 🚀 **Demo 地址**：https://tesshardy.github.io/techinsight/
- 📦 **GitHub 仓库**：https://github.com/TessHardy/techinsight
- 🛡️ **404 页面**：https://tesshardy.github.io/techinsight/404.html
...
| 🔗 **URL 状态同步** | 筛选/主题写入 URL，可分享链接 |
| 📄 **PDF 报告导出** | 完整内容一键导出 |
| 🚀 **返回顶部火箭** | 滚动 400px 后出现，火焰动画 |
| ♿ **a11y 友好** | ARIA 标签 + 键盘导航 + 减少动画偏好 |
| 🛡️ **404 错误页** | 主题同步的优雅错误页 |
| 🎯 **导航联动激活** | 滚动时自动高亮当前 section |
...
| 📍 导航激活不联动 | `IntersectionObserver` 自动高亮 |
| 📏 下划线长度错位 | `scaleX` + `left/right` 内缩对齐文字 |
...
- ✅ **Open Graph** 标签（Facebook/LinkedIn 分享卡片）
- ✅ **Twitter Card** 标签
